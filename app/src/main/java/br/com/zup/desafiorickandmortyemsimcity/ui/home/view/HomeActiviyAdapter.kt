...
class HomeActiviyAdapter(private var personagemList: MutableList<PersonagensResult>,
private val clickPersonagem: (personagem: PersonagensResult) -> Unit,
): RecyclerView.Adapter<HomeActiviyAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            PersonagensItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
